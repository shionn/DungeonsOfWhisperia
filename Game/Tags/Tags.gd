...
#const DUNGEON_01_POTION_NECROLIS = "DUNGEON_01_POTION_NECROLIS"
...
const DUNGEON_02_ALLIANCE = "DUNGEON_02_ALLIANCE"
const DUNGEON_02_VALTHORION_RING = "DUNGEON_02_VALTHORION_RING"
const DUNGEON_02_FINISHED = "DUNGEON_02_FINISHED"
